...
// Enhanced quality scoring class
...
// Enhance existing videos endpoint
router.post('/enhance-videos', async (req, res) => {
  try {
    ...
    res.json({
      ...
      stats: {
        ...
        average_quality_score: enhancedCount > 0 ? 'Improved (60+)' : 'No improvements needed'
      },
